...
L["unlameifier_sound_hl2_xbow.printname"] = "Βαλλιστρα"
L["unlameifier_sound_hl2_xbow.compactname"] = "Βαλλιστρα"
...
L["unlameifier_sound_hl2_ar22.printname"] = "Overwatch Standard Issue (Pulse-Rifle) Ενεργειακή Μπάλα"
L["unlameifier_sound_hl2_ar22.compactname"] = "AR2 ΕΜ"
...
L["unlameifier_sound_hl2_rpg.printname"] = "RPG (Εκτοξευτησ Ρουκετων)"
...
L["unlameifier_sound_hl2_smg.printname"] = "SMG (Υποπολυβολο)"
...
L["unlameifier_sound_dods_grenade.printname"] = "\"Οβίδες\""
L["unlameifier_sound_dods_grenade.compactname"] = "\"Οβίδες\""
...
L["unlameifier_sound_tf2_thirddegree.description"] = string.format(tf2desc.hit, "Third Degree") .. "\n\n" .. "Είναι ένα όφελος στους φίλους των δέντρων, στους ξυλοκόπους και στους διασπαστές ατόμων στον κόσμο αυτό, γιατί αυτή η θαυματουργή συσκευή καταστροφής ύλης καίει κάθε μεμονωμένο μόριο καθώς το διασπά."
...
L["unlameifier_sound_tf2_ballbuster_hit.description"] = string.format(tf2desc.hit, "Wrap Assassin") .. "\n\n" .. "Αυτά τα γλυκύτατα γιορτινά στολίδια είναι τόσο όμορφα φτιαγμένα, που οι αντίπαλοί σας θα θέλουν να τα δουν από κοντά. Ικανοποιήστε τους χτυπώντας αυτούς τους εύθραυστους γυάλινους βολβούς στα μάτια τους με 140 χιλιόμετρα την ώρα."
