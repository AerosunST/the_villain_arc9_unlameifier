...
-- Přínosné zařízení pro všechny dřevorubce, zálesáky a drtiče atomů. Toto zázračné zařízení spálí každou molekulu, kterou předtím rozštěpí.]]
...
-- Tyhle vánoční ozdoby jsou tak krásné, až se na ně tvůj nepřítel bude chtít podívat zblízka. Umožni mu to tím, že je odpálíš rychlostí 130 km/h do jeho očí.]]
...
L["unlameifier_sound_tf2_bottle_broken_hit.printname"] = "Bottle (Rozbitá)"
L["unlameifier_sound_tf2_bottle_broken_hit.compactname"] = "Bottle (R)"
